...
{{--                <div class="card-home">--}}
{{--                    <h2 class="text-primary fw-700">{{ \App\Models\Notice::whereHas('noticeType', function($q){ $q->where('priority', 'suggest'); })->count() }}</h2>--}}
{{--                    <div class="d-flex justify-content-between">--}}
{{--                        <p class="fs-14 text-secondary">عدد الاقتراحات</p>--}}
{{--                        @php $rate = checkRate('notices',null,null,null,'suggest'); @endphp--}}
...
{{--            <div class="col-lg-3 col-md-6 col-12 mb-3">--}}
{{--                <div class="card-home">--}}
{{--                    <h2 class="text-brown fw-700">{{ \App\Models\Notice::whereHas('noticeType', function($q){ $q->where('priority', 'suggest'); })->whereDate('created_at', now())->where('status', '0')->count() }}</h2>--}}
{{--                    <div class="d-flex justify-content-between">--}}
{{--                        <p class="fs-14 text-secondary">عدد الاقتراحات الجديدة</p>--}}
{{--                        @php $rate2 = checkRate('notices', 'status', '0',null, 'suggest'); @endphp--}}
...
{{--                <div class="card-home">--}}
{{--                    @php--}}
{{--                      $notice=  \App\Models\Notice::whereHas('noticeType', function($q){ $q->where('priority', 'suggest'); })--}}
{{--                    @endphp--}}
{{--                    <h2 class="text-brown fw-700">{{ $notice->whereDate('created_at', now())->where('status', '0')->count() }}</h2>--}}
{{--                    <div class="d-flex justify-content-between">--}}
{{--                        <p class="fs-14 text-secondary">عدد الاقتراحات التي تم تصعيدها</p>--}}
{{--                        @php $rate2 = checkRate('notices',null, 'status', '3', 'suggest'); @endphp--}}
{{--                        <div class="{{ $rate2 > 0 ? 'status-true' : ($rate2 < 0 ? 'status-false' : 'status-normal') }}">--}}
{{--                            <img class="h-16"--}}
{{--                                 src="{{ $rate2 == 0 ? asset('web/image/arrow-right.png') : ($rate2 > 0 ? asset('web/image/arrow-up-right.png') : asset('web/image/arrow-down-right.png')) }}">--}}
{{--                            <p>{{ number_format($rate2,1) }}%</p>--}}
...
{{--            <div class="col-lg-3 col-md-6 col-12 mb-3">--}}
{{--                <div class="card-home">--}}
{{--                    <h2 class="text-red fw-700">{{ \App\Models\Notice::whereHas('noticeType', function($q){ $q->where('priority', 'suggest'); })->where('status', '2')->count() }}</h2>--}}
{{--                    <div class="d-flex justify-content-between">--}}
{{--                        <p class="fs-14 text-secondary">عدد الاقتراحات المرفوضة</p>--}}
{{--                        @php $rate3 = checkRate('notices', 'status', '2',null, 'suggest'); @endphp--}}
...
{{--            <div class="col-lg-3 col-md-6 col-12 mb-3">--}}
{{--                <div class="card-home">--}}
{{--                    <h2 class="text-green fw-700">{{ \App\Models\Notice::whereHas('noticeType', function($q){ $q->where('priority', 'suggest'); })->where('status', '1')->count() }}</h2>--}}
{{--                    <div class="d-flex justify-content-between">--}}
{{--                        <p class="fs-14 text-secondary">عدد الاقتراحات التي تم حلها</p>--}}
{{--                        @php $rate4 = checkRate('notices', 'status', '1',null, 'suggest'); @endphp--}}
...
{{--    </div>--}}
    ...
    <div class="card-border mt-16">
        <div class="d-flex justify-content-between">
            <h5 class="text-primary"> الاقتراحات</h5>
        </div>
        <div>
            <div class="tabs">
                <div class="tabs-list d-flex mt-4">
                    <div class="show" data-content=".content-one">قائمة الاقتراحات</div>
                    <div data-content=".content-two">أدارة الاقتراحات</div>
                </div>
                <hr class="hr-card"/>
                    ...
                    <div class="content-one">
                        ...
                        <div class="form-filter card-details mt-4 mb-4">
                            <form class="row" action="" method="get">
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    <label for="validationDefault04" class="form-label fs-14 fw-500 text-primary">مرسل
                                        الاقتراح
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    <label for="validationDefault04" class="form-label fs-14 fw-500 text-primary">حالة
                                        الاقتراح
                                        <span class="text-red">*</span>
                                    </label>
                                    <select class="form-control" name="status" style="background-color: white">
                                        <option value="">الكل</option>
                                        <option value="1" {{ request('status') == '1' ? 'selected' : '' }}>مقبول
                                        </option>
                                        <option value="2" {{ request('status') == '2' ? 'selected' : '' }}>مرفوض
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6 col-12 mb-3">
                                    <label for="validationDefault04" class="form-label fs-14 fw-500 text-primary">تاريخ
                                        الارسال
                                        <span class="text-red">*</span>
                                    </label>
                        ...
                        <div class="scroll">
                            <table id="example1" class="data-table" style="width: 100%">
                                <thead>
                                <tr>
                                    <td style="width: 30%;">اسم الاقتراح</td>
                                    <td>مرسل الاقتراح</td>
                                    <td>درجة الأهمية</td>
                                    <td>حالة الاقتراح</td>
                                    <td>تاريخ الارسال</td>
                    ...
                    <div class="content-two">
                        ...
                        <div class="form-filter card-details mt-4 mb-4">
                            <form class="row" action="" method="get">
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    <label for="validationDefault04" class="form-label fs-14 fw-500 text-primary">مدة
                                        التصعيد التلقائى (بالدقائق)
                                        <span class="text-red">*</span>
                                    </label>
                        ...
                        <div class="scroll">
                            <table id="example1" class="data-table-1" style="width: 100%">
                                <thead>
                                <tr>
                                    <td style="width: 30%;">نوع الاقتراح</td>
                                    <td>مستوى الأهمية</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                >
                    ...
                    <p class="text-secondary fs-14 fw-400">يرجى إدخال بيانات الاقتراح </p>
                </div>
                <div class="modal-body">
                    <form class="row g-3" id="addSuggestionTypeForm" action="{{route('suggestion_type.store')}}"
                          method="POST">
                        @csrf
                        <div class="col-12">
...
@section('js')
    ...
    @section('js')
        ...
        <script>
            $(document).on('submit', '#addSuggestionTypeForm', function (e) {
                e.preventDefault();
                var formData = new FormData(this);
                console.log(formData);
                var url = $('#addSuggestionTypeForm').attr('action');
                $.ajax({
                    url: url,
                    type: 'POST',
                    data: formData,
        ...
        <script>
            ...
            $(document).on('submit', '#editNoticeTypeForm', function (e) {
                ...
                let url = "{{ route('suggestion_type.update', ':id') }}".replace(':id', id);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#editButton').html('تعديل نوع الاقتراح').attr('disabled', false);
                    },
                    error: function (xhr) {
        ...
        <script>
            ...
            let ajax = {
                "url": "{{ route('suggestion.datatable') }}",
                "type": "GET",
                data: function (d) {
        ...
        <script>
            ...
            let ajax2 = {
                "url": "{{ route('suggestion_type.datatable') }}",
                "type": "GET",
                data: function (d) {
