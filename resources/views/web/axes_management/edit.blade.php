...
{{--        <img class="h-24 me-3 ms-3" src="{{ asset('web/image/icon-breadcrumb.png') }}" alt="no-icon">--}}
{{--        <span class="fs-14 fw-400 text-secondary">تعديل محور</span>--}}
{{--    </div>--}}
{{--    <div class="card-border mt-16">--}}
{{--        <form action="{{ route('axesUpdate') }}" method="post" class="row g-3 form-group">--}}
{{--            @csrf--}}
{{--            <input type="hidden" name="id" value="{{ $axis->id }}">--}}
{{--            <div class="d-flex justify-content-between flex-wrap">--}}
{{--                <h5 class="text-primary">تعديل محور</h5>--}}
{{--                <div class="d-flex">--}}
{{--                    <a href="{{ route('axesManagement') }}" class="view border-0 me-3" >إلغاء</a>--}}
...
{{--                        <label class="form-label fs-14 fw-500 text-primary">اسم المحور<span--}}
{{--                                class="text-red">*</span></label>--}}
{{--                        <input name="name" value="{{ $axis->name }}" type="text"--}}
{{--                               class="form-control fs-12 fw-400 text-secondary bg-gray" placeholder="أدخل اسم المحور"--}}
{{--                               required>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div id="forms-container">--}}
{{--                    @foreach ($axis->axisQuestions->sortBy('order_number') as $index => $question)--}}
...
{{--                                                </label>--}}
{{--                                                <input name="questions[{{ $index }}][name]" type="text" value="{{ $question->question }}" data-index="{{ $index }}"--}}
...
{{--                                                    class="text-red">*</span></label>--}}
{{--                                            <select name="questions[{{ $index }}][answer_type]" class="form-select answer-type-select"--}}
{{--                                                    required data-index="{{ $index }}">--}}
{{--                                                <option value="0" {{ $question->answer_type == 0 ? 'selected' : '' }}>مقالي</option>--}}
{{--                                                <option value="1" {{ $question->answer_type == 1 ? 'selected' : '' }}>اختيار متعدد</option>--}}
{{--                                                <option value="2" {{ $question->answer_type == 2 ? 'selected' : '' }}>نعم ولا</option>--}}
{{--                                            </select>--}}
{{--                                        </div>--}}
{{--                                        <div class="col-12">--}}
{{--                                            <div class="mt-2 change-check">--}}
{{--                                                <input class="form-check-input me-2" name="questions[{{ $index }}][require_file]" type="checkbox" value="1" {{ $question->require_file ? 'checked' : '' }}>--}}
{{--                                                <label class="form-check-label fs-14">طلب رفع الأدلة والشواهد</label>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}

{{--                                        <!-- Multiple choice answers - show when answer type is 1 -->--}}
{{--                                        <div class="col-12 div-multiple-answer mt-3 {{ $question->answer_type == 1 ? '' : 'd-none' }}" data-index="{{ $index }}">--}}
...
{{--                                                                <div class="view text-center">الاجابة {{ $i + 1 }}</div>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="col-10 mb-2">--}}
{{--                                                                <input type="text" class="form-control w-100 fs-12 fw-400 text-primary bg-gray"--}}
{{--                                                                       name="questions[{{ $index }}][answer{{ $i + 1 }}]" value="{{ $question->answers[$i]->answer }}">--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                    @endfor--}}
{{--                                            @else--}}
...
{{--        </button>--}}
{{--    @elseif($axis->axisQuestions->count() == 0)--}}
{{--        <button id="duplicate-question" class="main-button blur">--}}
{{--            <img class="h-16" src="{{ asset('web/image/plus.svg') }}" alt="no-icon"> إضافة سؤال--}}
{{--        </button>--}}
{{--    --}}{{-- @endif --}}
{{--@endsection--}}
{{--@section('js')--}}
...
{{--                // Initialize the required attributes for multiple choice answers--}}
{{--                var answerType = newForm.find('.answer-type-select').val();--}}
{{--                var multipleAnswerDiv = newForm.find('.div-multiple-answer');--}}
{{--                var answerInputs = multipleAnswerDiv.find('input[type="text"]');--}}

{{--                if (answerType == '1') { // Multiple choice--}}
{{--                    multipleAnswerDiv.removeClass('d-none');--}}
{{--                    // Make all answer fields optional--}}
{{--                    answerInputs.prop('required', false);--}}
{{--                } else {--}}
...
{{--            // Handle answer type changes to show/hide multiple choice fields--}}
...
{{--                    if (answerType == '1') { // Multiple choice--}}
{{--                        multipleAnswerDiv.removeClass('d-none');--}}
{{--                        // Do not make answers required--}}
{{--                        // answerInputs.prop('required', true);--}}
{{--                    } else {--}}
{{--                        multipleAnswerDiv.addClass('d-none');--}}
{{--                        answerInputs.prop('required', false);--}}
{{--                    }--}}
...
{{--            // Also handle form submission to ensure all multiple-choice answers are optional--}}
{{--            $('form').on('submit', function(e) {--}}
{{--                // Remove required attribute from all multiple-choice answer fields--}}
{{--                $('.div-multiple-answer input').prop('required', false);--}}
{{--            });--}}
{{--    </script>--}}
{{--@endsection--}}
@extends('web.layouts.master')
                                    ...
                                    <div class="collapse me-3" id="collapseExample{{ $index }}">
                                        ...
                                        <div class="col-12 d-flex flex-column mt-3">
                                            ...
                                            <select name="questions[{{ $index }}][answer_type]" class="form-select answer-type-select"
                                                ...
                                                <option value="1" {{ $question->answer_type == 1 ? 'selected' : '' }}>اختيار متعدد</option>
                                                <option value="2" {{ $question->answer_type == 2 ? 'selected' : '' }}>نعم ولا</option>
                                                <option value="3" {{ $question->answer_type == 3 ? 'selected' : '' }}>تاريخ</option>
                                                    ...
                                                    @foreach($question->answers as $answerIndex => $answer)
                                                        <div class="row answer-row mb-2" data-answer-index="{{ $answerIndex + 1 }}">
                                                            ...
                                                            <div class="col-9 mb-2">
                                                                <input type="text" class="form-control w-100 fs-12 fw-400 text-primary bg-gray"
                                                                       name="questions[{{ $index }}][answers][{{ $answerIndex + 1 }}]" value="{{ $answer->answer }}">
                                                            </div>
