...
@section('content')
    ...
    <div class="card-border mt-16">
        <div class="d-flex justify-content-between flex-wrap">
            <h5 class="text-primary">إدارة مدير النظام</h5>
            <div class="d-flex">
            ...
            <button type="button" class="btn-filter">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                    ...
                    <path
                        ...
                        stroke="#9DA4AE" stroke-width="1.6" stroke-linecap="round"
            ...
            <form class="row" action="" method="get">
                ...
                <div class="col-md-6 col-12 mb-3">
                    ...
                    <select class="form-control" name="role" style="background-color: white">
                        ...
                        @foreach(\Spatie\Permission\Models\Role::where('guard_name','web')->latest()->get() as $role)
                            <option
                ...
                <div class="col-md-6 col-12 mb-3">
                    <label for="validationDefault04" class="form-label fs-14 fw-500 text-primary">حالة مدير النظام
                        <span class="text-red">*</span>
                    </label>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-gray d-flex flex-column align-items-start">
                    <h5 class="text-primary fs-18" id="addUserModalLabel">إضافة مدير نظام جديد</h5>
                </div>
                <div class="modal-body">
                    <form id="addUserForm" class="row g-3" action="{{ route('admins.store') }}" method="POST">
                        @csrf
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <label for="role" class="form-label fs-14 fw-500 text-primary">دور مدير نظام <span
                                    class="text-red">*</span></label>
                        ...
                        <div class="col-12">
                            <div class="mt-2 change-check">
                                <input class="form-check-input me-2" name="is_map" type="checkbox" value="1"
                                       id="flexCheckDefault1">
                                <label class="form-check-label fs-14" for="flexCheckDefault1">
                                    صلاحية الوصول الي الخريطة التفاعلية
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-12 d-flex justify-content-between border-top pt-3 mt-4">
                            ...
                            <button type="submit" id="AddUser" class="main-button">إرسال</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-gray d-flex flex-column align-items-start">
                    <h5 class="text-primary fs-18" id="editUserModalLabel">تعديل مدير نظام</h5>
                </div>
                <div class="modal-body">
                    <form id="editUserForm" class="row g-3">
                        ...
                        <div class="col-12">
                            <label for="editRole" class="form-label fs-14 fw-500 text-primary">دور مدير نظام <span
                                    class="text-red">*</span></label>
...
@section('js')
    <script>
        $(document).ready(function () {
            $('#addUserForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#AddUser').html('إرسال ').attr('disabled', false);
                    },
                    error: function (xhr) {
                        $('#AddUser').html('إرسال ').attr('disabled', false);
            ...
            $('#editUserForm').on('submit', function (e) {
                e.preventDefault();
                let formData = new FormData(this);
                let updateUrl = "{{ route('admins.update', ':id') }}".replace(':id', $('#editUserId').val());
    ...
    <script>
        function updateStatus(element) {
            ...
            let url = "{{ route('admins.updateStatus', ':id') }}".replace(':id', userId);
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.edit', function () {
                ...
                let url = "{{ route('admins.edit', ':id') }}".replace(':id', userId);
                $.ajax({
                    url: url,
                    method: 'GET',
                    success: function (data) {
                        ...
                        $('#is_map_checked').prop('checked', data.is_map == 1);
