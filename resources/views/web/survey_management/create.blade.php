...
@section('content')
    <div class="breadcrumb mt-4 mb-4">
        ...
        <img class="h-24 me-3 ms-3" src="{{ asset('web/image/icon-breadcrumb.png') }}" alt="no-icon">
        <span class="fs-14 fw-400 text-secondary">إضافة إستبيان</span>
    </div>
    <div class="card-border mt-16">
        <form action="{{ route('survey.store') }}" method="post" class="row g-3 form-group">
            @csrf
            <div class="d-flex justify-content-between flex-wrap">
                <h5 class="text-primary">إضافة إستبيان</h5>
                <div class="d-flex">
            ...
            <div>
                <div class="col-12">
                    <div class="change-direction">
                        <label class="form-label fs-14 fw-500 text-primary">اسم الإستبيان
                            <span class="text-red">*</span>
                        </label>
                        <input name="title" type="text" class="form-control fs-12 fw-400 text-secondary bg-gray"
                            placeholder="أدخل اسم الإستبيان" required>
                    </div>
                </div>
                <div class="col-12">
                    <div class="change-direction">
                        <label class="form-label fs-14 fw-500 text-primary">وصف الإستبيان
                            <span class="text-red">*</span>
                        </label>
                        <input name="description" type="text" class="form-control fs-12 fw-400 text-secondary bg-gray"
                            placeholder="أدخل وصف الإستبيان" required>
                    </div>
                </div>
